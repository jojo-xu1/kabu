			...
			<uni-view class="uni-row head">
				<view class="center-list">
					<view class="center-list-item border-bottom">
						...
						<text v-show="showUpImg01" class="navigat-arrow" @click="changeImg01">&#171;</text>
						<text v-show="!showUpImg01" class="navigat-arrow" @click="changeImg01">&#187;</text>
					</view>
				</view>
			</uni-view>
			<uni-view class="uni-column" v-show="showUpList01" v-model="kabuDaily01">
			...
			<uni-view class="uni-row head">
				<view class="center-list">
					<view class="center-list-item border-bottom">
						...
						<text v-show="showUpImg02" class="navigat-arrow" @click="changeImg02">&#171;</text>
						<text v-show="!showUpImg02" class="navigat-arrow" @click="changeImg02">&#187;</text>
					</view>
				</view>
			</uni-view>
			<uni-view class="uni-column" v-show="showUpList02" v-model="kabuDaily02">
			...
			<uni-view class="uni-row head">
				<view class="center-list">
					<view class="center-list-item border-bottom">
						...
						<text v-show="showUpImg03" class="navigat-arrow" @click="changeImg03">&#171;</text>
						<text v-show="!showUpImg03" class="navigat-arrow" @click="changeImg03">&#187;</text>
					</view>
				</view>
			</uni-view>
			<uni-view class="uni-column" v-show="showUpList03" v-model="kabuDaily03">
